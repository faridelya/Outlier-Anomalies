...
5. [Anomaly Detection in Python — Part 2; Multivariate Unsupervised Methods and Code](https://towardsdatascience.com/anomaly-detection-in-python-part-2-multivariate-unsupervised-methods-and-code-b311a63f298b)
